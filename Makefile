...
MAINFILES        = emulator.c \
	...
	platforms/macse/macse-platform.c \
	platforms/macse/macse_scsi.c \
...
ifeq ($(PLATFORM),PI3_BULLSEYE)
	...
	CFLAGS    = $(WARNINGS) -DENABLE_MACSE_VIRTUAL_SCSI -I. -I./raylib -I/opt/vc/include/ -march=armv8-a -mfloat-abi=hard -mfpu=neon-fp-armv8 -O3 -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -D_LARGEFILE64_SOURCE -lstdc++ $(ACFLAGS)
